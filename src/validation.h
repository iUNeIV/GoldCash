...
/** Default for DEFAULT_WHITGOLDSTRELAY. */
static const bool DEFAULT_WHITGOLDSTRELAY = true;
/** Default for DEFAULT_WHITGOLDSTFORCERELAY. */
static const bool DEFAULT_WHITGOLDSTFORCERELAY = true;
