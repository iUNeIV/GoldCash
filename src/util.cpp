...
const char * const BITCOIN_CONF_FILENAME = "goldcash.conf";
const char * const BITCOIN_PID_FILENAME = "goldcash.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Goldcash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Goldcash";
#else
    // Unix
    return pathRet / ".goldcash";
#endif
#endif
}
