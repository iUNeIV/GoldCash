...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s goldcash-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  goldcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded goldcash transaction") + "\n" +
              "  goldcash-tx [options] -create [commands]   " + _("Create hex-encoded goldcash transaction") + "\n" +
              "\n";
